...
class telemed_settings {
     ...
     *
     */
    public function telemed_settingsPage() {
        ...
        ?>
        <div class="wrap">
            <h2><?php echo('Telemed Payments'); ?></h2>
            ...
            <form name="clearent_clear_log" method="post"
                ...
                <input type="hidden" name="action" value="tmpclearlog" />
